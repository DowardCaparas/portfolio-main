    ...
    >
      ...
      <div className="max-md:hidden">
        <div className="flex gap-1 text-white text-sm">
          ...
          <Link
            href="/Caparas-Dounhuward-Resume.pdf" // Path to your PDF in the 'public' folder
            className="bg-white rounded-md px-5 text-md text-black font-semibold flex items-center
             gap-2 my-2 hover:bg-gray-100 active:bg-gray-200"
            target="_blank" // Opens the link in a new tab
            rel="noopener noreferrer" // Security enhancement to prevent tab hijacking
          >
            <Image
                  src="/file.svg"
                  alt="file icon"
          ...
          >
            ...
            `}
              ...
              <Link
                href="/Caparas-Dounhuward-Resume.pdf" // Path to your PDF in the 'public' folder
                className="bg-white rounded-md px-5 text-md text-black font-semibold flex items-center
                 gap-2 hover:bg-gray-100 active:bg-gray-200 mx-4 py-3 mt-6 "
                target="_blank" // Opens the link in a new tab
                rel="noopener noreferrer" // Security enhancement to prevent tab hijacking
              >
                <Image
